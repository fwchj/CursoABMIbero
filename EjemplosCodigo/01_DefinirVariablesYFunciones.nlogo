...
to setup
  ...
  suma2 a c  ; aqui usamos otra funcion que imprime directamente a dentro de la funcion

  print(getRandomValue) ; aqui solicitamos el valor de una funcion e imprimimos el resultado
